...
class Gastrodax_OneStepCheckout_OnestepController extends Mage_Checkout_OnepageController
{
    /**
     ...
     *
     * @return Gastrodax_OneStepCheckout_Model_Type_Onestep
     */
    public function getOnestep()
    {
        return Mage::getSingleton('gd_onestepc/type_onestep');
    }
    ...
    {
        if (!Mage::helper('gd_onestepc')->oneStepCheckoutEnabled()) {
