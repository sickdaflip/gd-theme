...
class Gastrodax_OneStepCheckout_Block_Onestep_Billing extends Mage_Checkout_Block_Onepage_Billing
{
    ...
    public function getAddressesHtmlSelect($type)
    {
        if ($this->isCustomerLoggedIn()) {
            ...
            foreach ($options as $option) {
                ...
                $html .= ' data-abide-ignore/><label for="' . $type . '-address-id-' . $option['value'] . '">' . $option['label'] . '</label>'
                    . PHP_EOL;
            ...
            $html .= '<div><input type="radio" name="' . $type . '_address_id" value="" id="' . $type . '-address-id-" data-abide-ignore />';
